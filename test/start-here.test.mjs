...
const CREATED = ['what-is-a-stock', 'what-is-the-stock-market', 'why-invest', 'tickers-and-indices', 'funds-and-etfs', 'how-to-read-a-chart', 'bulls-bears-and-crashes', 'volatility-and-the-vix'];
